...
// Чтобы подключить Yandex Metrika — задайте NEXT_PUBLIC_YANDEX_METRIKA_ID=12345678
// Без неё блок аналитики просто не рендерится. Тестово работать локально не нужно.
  ...
  return (
    <html lang="ru">
      ...
      <body>
        ...
        {/* Yandex Metrika — только если задан NEXT_PUBLIC_YANDEX_METRIKA_ID. afterInteractive не блокирует first paint */}
        {metrikaId && (
          <>
            <Script
              id="yandex-metrika"
